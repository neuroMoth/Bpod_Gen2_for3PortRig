...
switch op
    case 'init'
        ...
        hPos = 5;
        maxVPos = 0;
        BpodSystem.ProtocolFigures.ParameterGUI = figure('Position', [50 100 450 guiHeight],'name', 'Parameter GUI',...
        ...
        for p = 1:nPanels
            ...
            uipanel('title', panelNames{p},'FontSize',11, 'FontWeight', 'Bold', 'BackgroundColor', 'white',...
                'Units', 'Pixels', 'Position',[hPos vPos 280 thisPanelHeight]);
            inPanelPos = 5;
            for i = 1:nParams
                ...
                switch lower(thisParamStyle)
                    case 'edit'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'edit',... 
                            'String', num2str(thisParam), 'Position', [hPos+180 vPos+inPanelPos+2 90 25],... 
                    ...
                    case 'checkbox'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'checkbox',... 
                            'Value', thisParam, 'String', '   (check to activate)', 'Position', [hPos+180 vPos+inPanelPos+4 90 25],... 
                            'FontWeight', 'normal', 'FontSize', 11, 'BackgroundColor','white', 'FontName', 'Arial',...
                            'HorizontalAlignment','Center');
                    case 'popupmenu'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'popupmenu',... 
                            'String', thisParamString, 'Value', thisParam, 'Position', [hPos+180 vPos+inPanelPos+2 90 25],... 
                            'FontWeight', 'normal', 'FontSize', 11, 'BackgroundColor','white', 'FontName', 'Arial',...
                            'HorizontalAlignment','Center');
                    case 'pushbutton'
                        ...
                        BpodSystem.GUIHandles.ParameterGUI.Params(paramNum) = uicontrol('Style', 'pushbutton',... 
                            'String', thisParamName, 'Position', [hPos+180 vPos+inPanelPos+2 90 25], 'FontWeight', 'normal',... 
        ...
        set(BpodSystem.ProtocolFigures.ParameterGUI, 'Position', [1030 45 hPos+280 maxVPos-10]);
    case 'sync'
